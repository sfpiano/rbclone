...
from diffviewer.models import DiffSet, FileDiff
from diffviewer.templatetags.difftags import highlightregion
import diffviewer.diffutils as diffutils
import diffviewer.parser as diffparser
